// <copyright file="TaskToReturnModel.cs" company="PomodoroGroup_GL_BaseCamp">
...
{
    /// <summary>
    /// Represents a view model which is being returned to the user.
    /// </summary>
    public class TaskToReturnModel : BaseUserOrientedViewModel
    {
        /// <summary>
